...
type ProductService interface {
	...
	GetProducts(search, classify string, categoryID uint, minPrice, maxPrice float64, minRating float64, sort string, page, limit int) (*responses.ListResponse[*responses.ProductData], error)
...
func (s *productService) GetProducts(search, classify string, categoryID uint, minPrice, maxPrice float64, minRating float64, sort string, page, limit int) (*responses.ListResponse[*responses.ProductData], error) {
	...
	if len(products) == 0 {
		return &responses.ListResponse[*responses.ProductData]{
			Items:      []*responses.ProductData{},
